...
namespace NasleGhalam.DomainClasses.EntityConfigs
{
    public class ResumeConfig : EntityTypeConfiguration<Resume>
    {
        public ResumeConfig()
        {
            ...
            Property(x => x.Phone).HasMaxLength(8).IsRequired();
            Property(x => x.Mobile).HasMaxLength(10).IsRequired();
            ...
            Property(x => x.FatherPhone).HasMaxLength(10);
            Property(x => x.MotherJob).HasMaxLength(150);
            Property(x => x.MotherPhone).HasMaxLength(10);
            Property(x => x.PartnerJob).HasMaxLength(150);
            Property(x => x.PartnerPhone).HasMaxLength(10);
            Property(x => x.PhoneReagent1).HasMaxLength(10);
            Property(x => x.AddressReagent1).HasMaxLength(300);
            Property(x => x.PhoneReagent2).HasMaxLength(10);
