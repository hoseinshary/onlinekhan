<template>
  <my-modal-create :title="modelName" size="lg" :show="isOpenModalCreate" @confirm="submitCreate" @reset="resetCreateStore" @close="toggleModalCreateStore(false)" @open="modalOpen">
  ...
  watch: {
    "instanceObj.EducationTreeIds"(newVal) {
      ...
      if(this.isOpenModalCreate)
        this.getEducationGroupsUnderSelectedList({lstSelected:newVal,isEdit:false,eduGroupsId:[],Ratios:null});
    }
  }
};
</script>
