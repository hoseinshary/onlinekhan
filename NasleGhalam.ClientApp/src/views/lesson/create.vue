<template>
  <my-modal-create
    ...
    @open="modalOpen"
  >
    <!-- @confirm="educationGroupListLesson = educationGroupList; submitCreateStore;" -->
    <div class="col-12 row">
      <div class="col-md-4 row">
        <q-slide-transition>
          <q-tree
            ...
            class="col-md-12"
            color="blue"
            :ticked.sync="instanceObj.EducationTreeIds"
            tick-strategy="leaf"
            accordion
            node-key="Id"
            ref="topicTree"
      ...
      <div class="col-md-8 row">
        ...
        <my-field class="col-md-6" :model="$v.instanceObj.IsMain">
        ...
        <my-select
          ...
          clearable
        />
        <my-select :model="$v.instanceObj.GradeId" :options="gradeDdl" class="col-md-4" clearable/>
        <my-select
        ...
        />
        <q-slide-transition>
          <fieldset class="col-12" v-if="educationGroupList.length > 0">
        ...
        >
          <q-slide-transition>
            <fieldset class="col-12" v-if="group.SubGroups.length > 0">
  ...
  export default {
    ...
    methods: {
      ...
      submitCreate: function() {
        ...
        this.submitCreateStore("mosiiiiiiiiiiiiiiiii");
      }
    },
    /**
     * computed
    ...
    watch: {
      "instanceObj.EducationTreeIds"(newVal) {
        this.getEducationGroupsUnderSelectedList(newVal);
        console.log("tick");
        console.log(newVal);
      }
    }
