...
namespace NasleGhalam.ServiceLayer.Services
{
    public class ActionService
    {
        ...
        ///// <param name="id"></param>
        ///// <returns></returns>
        //public short GetActionBit(int id)
        //{
        //    var action = _actions.Find(id);
        //    return action?.ActionBit ?? 0;
        //}
        ...
        //        .Where(current => current.ControllerId == 0 || current.ControllerId == controllerId)
