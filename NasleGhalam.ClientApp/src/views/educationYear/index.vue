  ...
  <section class="col-md-8">
    ...
    <my-panel>
      ...
      <div slot="body">
        ...
        <br>
        <my-table :grid-data="educationYearGridData"
                  :columns="educationYearGridColumn"
                  hasIndex>
          <template slot="IsActiveYear"
                    slot-scope="data">
            <q-checkbox v-model="data.row.IsActiveYear"
                        readonly />
          </template>
          <template slot="Id"
                    slot-scope="data">
...
export default {
   ...
   */
  data() {
    var pageAccess = this.$util.initAccess('/educationYear');
    return {
      pageAccess,
  ...
  computed: {
    ...mapState('educationYearStore', {
      modelName: 'modelName',
      educationYearGridData: 'educationYearGridData'
    })
  },
  created() {
    this.fillGridStore();
