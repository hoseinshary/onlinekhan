<template>
  <base-modal-create
    ...
    :show="teacherGroupStore.openModal.createSub"
    @confirm="teacherGroupStore.submitCreate"
    @reset="teacherGroupStore.resetCreateSub"
    @close="teacherGroupStore.OPEN_MODAL_CREATE_SUB(false)"
  >
    ...
    <br />
    <div class="">
        <base-table :grid-data="teacherGroupStore.studentDataForSub" :columns="studentGridColumn">
...
export default class TeacherGroupVue extends Vue {
  ...
  created() {
    ...
    this.teacherGroupStore.SET_CREATESUB_VUE(this);
